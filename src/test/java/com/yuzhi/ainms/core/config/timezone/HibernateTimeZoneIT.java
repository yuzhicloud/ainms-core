package com.yuzhi.ainms.core.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.yuzhi.ainms.core.IntegrationTest;
import com.yuzhi.ainms.core.repository.timezone.DateTimeWrapper;
import com.yuzhi.ainms.core.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM ainms_date_time_wrapper where id=%d", fieldName, id);
    }
