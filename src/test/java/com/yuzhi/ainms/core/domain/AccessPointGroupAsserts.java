...
public class AccessPointGroupAsserts {
   ...
   */
  public static void assertAccessPointGroupAllPropertiesEquals(
    AccessPointGroup expected,
    AccessPointGroup actual
  ) {
   ...
   * @param actual the actual entity
   */
  public static void assertAccessPointGroupAllUpdatablePropertiesEquals(
    AccessPointGroup expected,
    AccessPointGroup actual
  ) {
   ...
   * @param actual the actual entity
   */
  public static void assertAccessPointGroupAutoGeneratedPropertiesEquals(
    AccessPointGroup expected,
    AccessPointGroup actual
  ) {
    assertThat(expected)
   ...
   * @param actual the actual entity
   */
  public static void assertAccessPointGroupUpdatableFieldsEquals(
    AccessPointGroup expected,
    AccessPointGroup actual
  ) {
    assertThat(expected)
   ...
   * @param actual the actual entity
   */
  public static void assertAccessPointGroupUpdatableRelationshipsEquals(
    AccessPointGroup expected,
    AccessPointGroup actual
  ) {
    assertThat(expected)
      ...
      .satisfies(
        e ->
          assertThat(e.getController())
            .as("check controller")
            .isEqualTo(actual.getController())
      )
      .satisfies(
        e ->
          assertThat(e.getPowerPlant())
            .as("check powerPlant")
            .isEqualTo(actual.getPowerPlant())
      );
  }
}
