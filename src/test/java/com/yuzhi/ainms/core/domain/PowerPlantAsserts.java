...
public class PowerPlantAsserts {
   ...
   */
  public static void assertPowerPlantAllPropertiesEquals(
    PowerPlant expected,
    PowerPlant actual
  ) {
   ...
   * @param actual the actual entity
   */
  public static void assertPowerPlantAllUpdatablePropertiesEquals(
    PowerPlant expected,
    PowerPlant actual
  ) {
   ...
   * @param actual the actual entity
   */
  public static void assertPowerPlantAutoGeneratedPropertiesEquals(
    PowerPlant expected,
    PowerPlant actual
  ) {
    assertThat(expected)
   ...
   * @param actual the actual entity
   */
  public static void assertPowerPlantUpdatableFieldsEquals(
    PowerPlant expected,
    PowerPlant actual
  ) {
    assertThat(expected)
      ...
      .satisfies(
        e ->
          assertThat(e.getPowerPlantName())
            .as("check powerPlantName")
            .isEqualTo(actual.getPowerPlantName())
      );
  }
   ...
   * @param actual the actual entity
   */
  public static void assertPowerPlantUpdatableRelationshipsEquals(
    PowerPlant expected,
    PowerPlant actual
  ) {
    assertThat(expected)
