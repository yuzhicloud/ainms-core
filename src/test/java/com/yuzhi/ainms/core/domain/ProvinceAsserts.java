...
public class ProvinceAsserts {
    ...
    public static void assertProvinceUpdatableFieldsEquals(Province expected, Province actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getProvinceCode()).as("check provinceCode").isEqualTo(actual.getProvinceCode()))
            .satisfies(e -> assertThat(e.getProvinceName()).as("check provinceName").isEqualTo(actual.getProvinceName()));
    }
