...
/**
 * REST controller for managing {@link com.yuzhi.ainms.core.domain.Province}.
 */
@RestController
...
public class ProvinceResource {
  ...
  public ResponseEntity<Province> partialUpdateProvince(
    ...
    log.debug(
      "REST request to partial update Province partially : {}, {}",
      id,
      province
    );
    if (province.getId() == null) {
