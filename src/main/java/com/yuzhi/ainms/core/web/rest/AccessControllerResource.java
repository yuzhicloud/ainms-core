...
/**
 * REST controller for managing {@link com.yuzhi.ainms.core.domain.AccessController}.
 */
@RestController
...
public class AccessControllerResource {
  ...
  private final Logger log = LoggerFactory.getLogger(
    AccessControllerResource.class
  );
   ...
   */
  @PostMapping("")
  public ResponseEntity<AccessController> createAccessController(
    ...
    if (accessController.getId() != null) {
      throw new BadRequestAlertException(
        "A new accessController cannot already have an ID",
        ENTITY_NAME,
        "idexists"
      );
    }
    ...
    return ResponseEntity.created(
      new URI("/api/access-controllers/" + accessController.getId())
    )
      .headers(
        HeaderUtil.createEntityCreationAlert(
          ...
          true,
          ENTITY_NAME,
          accessController.getId().toString()
        )
      )
  ...
  public ResponseEntity<AccessController> updateAccessController(
    ...
    log.debug(
      "REST request to update AccessController : {}, {}",
      id,
      accessController
    );
    if (accessController.getId() == null) {
  ...
  public ResponseEntity<AccessController> partialUpdateAccessController(
    ...
    log.debug(
      "REST request to partial update AccessController partially : {}, {}",
      id,
      accessController
    );
    if (accessController.getId() == null) {
    ...
    Optional<AccessController> result = accessControllerService.partialUpdate(
      accessController
    );
   ...
   */
  @DeleteMapping("/{id}")
  public ResponseEntity<Void> deleteAccessController(
    @PathVariable("id") Long id
  ) {
